    ...
    <div className="min-h-screen pt-24 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-xl">
          ...
          <Link
            href="/blog"
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-600 rounded-xl font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-all text-sm"
          >
            Browse as Guest
          </Link>
